...
const { get, create, update, remove } = require("../models/blog/butterflies");
const { validateButterfly, ButterflyCreate, ButterflyUpdate } = require("../models/blog/validate");
...
const createButterfly = async (req, res) => {
  try {
    await validateButterfly(req.body, ButterflyCreate);
...
const updateButterfly = async (req, res) => {
  try {
    await validateButterfly(req.body, ButterflyUpdate);
